...
public class Main {
    public static void main(String[] args) {
        ...
        // Match semiFinal1 = new Match(1, FOOTBALL, team1, team2, "01/06/2025",
        // "Stadium A");
        // Match semiFinal2 = new Match(2, FOOTBALL, team3, team4, "01/06/2025",
        // "Stadium B");
        ...
        // System.out.println("Winner from manager leaf1: " +
        // leaf1.getMatch().getMatchManager().getWinner());

        // System.out.println("Finalistes : " + finalist1 + " VS " + finalist2);

        // Match finalMatch = new Match(3, FOOTBALL, finalist1, finalist2, "02/06/2025",
        // "Final Arena");
