...
public class TestFootball1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        manager3.applyEvent(new Substitution(manager3, t3a.getTeamMembers()[1], t3a.getTeamMembers()[10]));
        ...
        manager4.applyEvent(new Substitution(manager4, t4b.getTeamMembers()[2], t4b.getTeamMembers()[7]));
        ...
        manager5.applyEvent(new Substitution(manager5, t5a.getTeamMembers()[0], t5a.getTeamMembers()[10]));
        ...
        manager6.applyEvent(new Substitution(manager6, t6b.getTeamMembers()[6], t6b.getTeamMembers()[5]));
